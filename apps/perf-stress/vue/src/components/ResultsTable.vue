  ...
  <div v-if="results.length > 0" class="mt-8">
    ...
    <div class="overflow-x-auto">
      <table class="w-full text-sm border-collapse">
        ...
        <tbody>
          <tr v-for="(r, i) in results" :key="i" class="border-t border-gray-200 hover:bg-gray-50">
            ...
            <td class="p-3 text-gray-500 text-xs">{{ new Date(r.timestamp).toLocaleTimeString() }}</td>
          </tr>
        </tbody>
      </table>
    </div>
